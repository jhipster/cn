...
## <i class="fa fa-warning"></i> Error: login already used

### Error description

This is a JHipster error that is used when the end-user tries to use a login name that is already being used.
